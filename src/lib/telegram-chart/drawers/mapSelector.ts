import { mixNumberColors, mixNumberColorsAndOpacitiesToRGBA, numberColorToRGBA } from '../helpers';
import {
...
function drawNotch(ctx: CanvasRenderingContext2D, centerX: number, centerY: number, cssColor: string, pixelRatio: number) {
