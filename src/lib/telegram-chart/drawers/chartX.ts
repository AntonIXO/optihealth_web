...
import { chartSidePadding, chartDateScaleLabelMargin, chartMapHeight, chartMapBottom } from '../constants';
import drawDateScale from './dateScale';
import drawMapSelector from './mapSelector';

export default function makeChartX(ctx: CanvasRenderingContext2D, dates: number[], minIndex: number, maxIndex: number) {
